  ...
  return (
    <Box sx={{ flexShrink: 0, ml: 0.75, display: 'flex', alignItems: 'center' }}>
      <Tooltip title="Giỏ hàng">
        <IconButton size="large" sx={{ color: 'text.primary', mr: 1 }} onClick={() => navigate('/cards')}>
      ...
      >
        <Stack direction="row" spacing={1.25} alignItems="center" sx={{ p: 0.5 }}>
          <Avatar alt="profile user" src={profile.avatar || '/assets/images/default-avatar.png'} size="sm" />
                    ...
                    <Grid container justifyContent="space-between" alignItems="center">
                      <Grid item>
                        <Stack direction="row" spacing={1.25} alignItems="center">
                          ...
                          <Stack>
                            <Typography variant="h6">{profile.fullName || 'Đang tải...'}</Typography>
